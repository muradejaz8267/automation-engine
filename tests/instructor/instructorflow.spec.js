// instructorflow.spec.js - End-to-end test for creating a Course on FastLearner staging
const { test, expect } = require('@playwright/test');

// Import Page Object Model classes
const LoginPage = require('../../pages/LoginPage');
const InstructorFlow = require('../../pages/instructorflow');

// Verify InstructorFlow is a constructor
if (typeof InstructorFlow !== 'function') {
  throw new Error(`InstructorFlow is not a constructor. Got: ${typeof InstructorFlow}, value: ${InstructorFlow}`);
}
...
test.describe('Create Course Flow', () => {
  test('Complete flow: Login, create course with sections & topics', async ({ page }) => {
    ...
    const instructorFlow = new InstructorFlow(page);
    ...
    try {
      ...
      await instructorFlow.addAdditionalQuizTopic();
