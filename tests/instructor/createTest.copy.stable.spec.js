// createTest.spec.js - Test for creating a test on FastLearner
...
test.describe('Create Test Flow', () => {
  test('Complete flow: Login and create a test', async ({ page }) => {
    // Increase test timeout for complex multi-step form with 95 quiz questions
    // Each question takes ~5-10 seconds, so 95 questions = 8-16 minutes minimum
    // Plus form filling, navigation, etc. - set to 30 minutes to be safe
    ...
    // Define quiz questions data - 50 USMLE Step 1 questions with options and correct answers
    const quizQuestions = [
      {
      ...
      },
      {
        ...
        options: [
          'Im sorry, but I would no longer be able to be your doctor if you pursue a home birth.',
          'I would like to meet with your friend before I decide.',
          'If theres a problem, I could still act as your doctor if you arrive at the hospital in labor.',
          'Lets set up an appointment next week to discuss your birth plan in detail. (E)Perhaps your midwife could act as your birth coach instead.'
        ],
        correctOptionIndex: 3
      },
      {
        questionText: 'A 36-year-old woman with hypertension comes to the office because she thinks she may begoing through early menopause. She has not had a menstrual period since her most recent office visit 6 months ago. During this time, she also has beengaining weight around the middle despite increased exercise; she has had a 6.3-kg (14-lb) weight gain. She has no other history of major medical illness. Her only medication is lisinopril. She does not smoke, drink alcohol, or use illicit drugs. She is 168 cm (5 ft 6 in) tall and weighs 107 kg (236 lb); BMI is 38 kg/m2. Vital signs are within normal limits. Examination shows a uterus consistent in size with a 24-week gestation. Pelvic ultrasonography shows oligohydramnios and a fetus with a misshapen cranium, pericardial effusion, small bladder, and echogenic bowel. The most likely cause of the fetal abnormalities in this patients pregnancy is interference with which of the following?',
        options: [
      ...
      },
      {
        ...
        options: [
          ...
          'Increased concentration of mllerian-inhibiting substance',
      ...
      {
        questionText: 'A 58-year-old man with chronic obstructive pulmonary disease comes to the clinic with his wife for a follow-up examination. He has smoked one pack of cigarettes daily for 35 years. He has tried to quit smoking twice but was unsuccessful both times. At todays visit, when the physician asks the patient about smoking cessation, he says he is not ready to do so. The patients wife states her husbands smoking makes her cough and gives her chest tightness. Which of the following is the most appropriate physician statement?',
        options: [
      ...
      {
        questionText: 'A 37-year-old man who is a carpenter is brought to the emergency department 45 minutes after the sudden onset of fever, shortness of breath, and palpitations. Four days ago, he sustained a puncture wound to his left hand; he treated the wound with antibacterial cream and a bandage. His temperature is 39C (102.2F), pulse is 120/min, respirations are 28/min, and blood pressure is 100/60 mm Hg. Examination of the left hand shows diffuse swelling, erythema, and a 2-cm, necrotic puncture wound. His leukocyte count is 14,000/mm3. Arterial blood gas analysis on room air shows a PCO2 of less than 32 mm Hg. Which of the following is the most likely infectious agent in this patient?',
        options: [
          'Clostridium tetani',
      ...
      {
        questionText: 'A 45-year-old woman comes to the office for a follow-up examination 2 weeks after she sustained a vertebral fracture at L1. The fracture occurred spontaneously and there is no history of trauma to the area or other fractures. She gained 27 kg (60 lb) during the 6 months before the fracture occurred. Her only medication is hydromorphone as needed for pain. She is 163 cm (5 ft 4 in) tall and now weighs 100 kg (220 lb); BMI is 38 kg/m2. Temperature is 37.0C (98.6F), pulse is 86/min, respirations are 12/min, and blood pressure is 145/98 mm Hg. Physical examination shows central obesity and purple striae over the abdomen bilaterally. The lower extremities appear thin. Results of laboratory studies are shown: Plasma Renin activity 5.0 ng/mL/h (N=0.64.0) Metanephrine 0.3 nmol/L (N<0.4) Serum Cortisol, random 43 ?g/dL Adrenocorticotropic hormone 120 pg/mL (N<120) Aldosterone 8 ng/dL (N=29) Urine 24-hour free cortisol excretion 340g/24 h (N=3.545) The most likely cause of the fracture in this patient is an increase in which of the following processes?',
        options: [
          'Calcium absorption',
          'Calcium excretion',
      ...
      {
        questionText: 'Patient Information Age: 16 years Gender: M, self-identified Race/Ethnicity: Hispanic, self-identified Site of Care: clinic History Reason for Visit/Chief Concern: "I haven\'t started puberty yet." History of Present Illness: absence of pubic and facial hair small penis and testicle size Past Medical History: no serious illness Medications: none Allergies: no known drug allergies Psychosocial History: does not smoke cigarettes, drink alcoholic beverages, or use other substances Physical Examination Temp Pulse Resp BP O2 Sat Ht Wt BMI 36.0C 76/min 13/min 108/61 mm Hg 98% 184 cm 90 kg 27 kg/m2 (96.8F) on RA (6 ft) (198 lb) 90th %ile 97th %ile Appearance: long extremities Skin: no facial or axillary hair HEENT: PERRLA Chest: bilateral gynecomastia Pulmonary: clear to auscultation Cardiac: normal S1 and S2 Abdominal: normoactive bowel sounds; no tenderness to palpation; no hepatosplenomegaly Genitourinary: small testicular and penile size; minimal pubic hair; SMR 2 Neurologic: muscle strength 5/5 throughout Diagnostic Studies: Serum Follicle-stimulating hormone 45 mIU/mL Luteinizing hormone 34 mIU/mL Testosterone 45 ng/dL (N=270950) TSH 2.2 ?U/L 94th %ile Question: Which of the following is the most likely underlying cause of this patient\'s condition?',
        options: [
      ...
      },
      {
        ...
        options: [
          ...
          '8993',
          '9992',
          '10,012 ANSWER FORM FOR USMLE STEP 1 SAMPLE TEST QUESTIONS Block 1 (Questions 140)'
        ],
        correctOptionIndex: 3
      }
    ];
