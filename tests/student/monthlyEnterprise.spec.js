// monthlyEnterprise.spec.js - Monthly Enterprise Instructor Plan flow
// Same as annualEnterprise but clicks Monthly before Get Started
...
test.describe('Monthly Enterprise', () => {
  test.setTimeout(180000);

  test('signup, click Monthly, click Enterprise Instructor Plan Get Started, fill payment form', async ({ page, context }) => {
    // Step 1: Signup
