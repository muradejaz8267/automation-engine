// monthlyStandard.spec.js - Monthly Standard Subscription flow
// Same as annualStandardSubscription but clicks Monthly before Get Started
...
test.describe('Monthly Standard Subscription', () => {
  test.setTimeout(180000);

  test('signup, click Monthly, click Standard Student Plan Get Started, fill payment form', async ({ page, context }) => {
    // Step 1: Signup
