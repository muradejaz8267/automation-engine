// annualEnterprise.spec.js - Annual Enterprise Instructor Plan flow
// Same flow as annualStandardSubscription but clicks Get Started for Enterprise Instructor Plan
...
test.describe('Annual Enterprise', () => {
  test.setTimeout(180000);

  test('signup, click Enterprise Instructor Plan Get Started, fill payment form', async ({ page, context }) => {
    // Step 1: Signup
    ...
    const getStartedBtn = page.locator("xpath=//h3[contains(.,'Enterprise Instructor Plan')]/ancestor::div[contains(@class,'content-header')]//span[normalize-space()='Get Started']");
    await getStartedBtn.waitFor({ state: 'visible', timeout: 20000 });
    await delay(3000);
    await getStartedBtn.scrollIntoViewIfNeeded();
    await delay(500);
    await getStartedBtn.click();
    console.log('✓ Step 2: Clicked Get Started for Enterprise Instructor Plan');
