// annualStandardSubscription.spec.js - Annual Standard Subscription flow
// 1: Signup (new user)
...
test.describe('Annual Standard Subscription', () => {
  test.setTimeout(180000);

  test('signup, click Standard Student Plan Get Started, fill payment form', async ({ page, context }) => {
    // Step 1: Signup
