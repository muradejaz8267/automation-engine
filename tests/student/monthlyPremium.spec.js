// monthlyPremium.spec.js - Monthly Premium Instructor Plan flow
// Same as annualPremium but clicks Monthly before Get Started
...
test.describe('Monthly Premium', () => {
  test.setTimeout(180000);

  test('signup, click Monthly, click Premium Instructor Plan Get Started, fill payment form', async ({ page, context }) => {
    // Step 1: Signup
    ...
    // Step 2: Navigate to pricing page via Pricing link
    ...
    // Step 2a: Click Monthly before Get Started
